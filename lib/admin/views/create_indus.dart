...
class CreateIndus extends StatefulWidget {
  @override
  _CreateIndusState createState() => _CreateIndusState();
}

class _CreateIndusState extends State<CreateIndus> {
  String productName,price,description,companyName,contact;
  String item = 'Pipeline';
  ...
  uploadBlog() async {
    if (selectedImage != null) {
      ...
      crudMethods.addData2(blogMap).then((result) {
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        items: <String>['Pipeline', 'Coolers', 'Brushes', 'Wears','Crusher']
